                    ...
                    <form class="form-inline">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn custom-btn" type="submit"><img class="search-btn"
                                        src="./image/icons/icons8-search-144.png">
                                </button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class=" card-body chat box" id="chatBox">
                        <span class="span-title">Shortcut</span>
                        <button class="btn btn-prompt-action"><img class="send-icon"
                                src="./image/icons/icons8-add-96.png" alt=""></button>
                        <button class="btn btn-prompt-action"><img class="send-icon"
                                src="./image/icons/icons8-edit-144.png" alt=""></button>
                        <button class="btn btn-prompt-action"><img class="send-icon"
                                src="./image/icons/icons8-delete-144.png" alt=""></button>
                        <button class="btn btn-prompt-action"><img class="send-icon"
                                src="./image/icons/icons8-archive-100.png" alt=""></button>
                        <button class="btn btn-prompt-action"><img class="send-icon"
